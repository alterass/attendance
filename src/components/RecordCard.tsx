...
import { calcHours, formatDate, formatTime, formatWeekday } from '../utils/time';
...
const typeStyleMap: Record<string, { color: string; border: string }> = {
  加班: { color: 'amber', border: 'border-l-amber-400' },
  调休: { color: 'blue', border: 'border-l-blue-400' },
  请假: { color: 'green', border: 'border-l-emerald-400' },
};
