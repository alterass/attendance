...
import { calcHours, formatDateTime } from '../../utils/time';
...
function RecordSuccessPage() {
  ...
  const hours = calcHours(
    lastCreatedRecord.beginTime,
    lastCreatedRecord.overTime,
  ...
  return (
    <div className="min-h-screen p-4 max-w-lg mx-auto flex flex-col items-center justify-center">
      ...
      <div className="text-center mb-8">
        ...
        <Typography.Text type="tertiary">考勤记录已保存</Typography.Text>
      </div>
      ...
      <div className="w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6 mb-8 border border-white/50">
        <div className="flex items-center gap-2 mb-4">
          <Tag
            size="large"
            color={
              lastCreatedRecord.type === '加班'
                ? 'amber'
                : lastCreatedRecord.type === '调休'
                  ? 'blue'
                  : 'green'
            }
            type="light"
